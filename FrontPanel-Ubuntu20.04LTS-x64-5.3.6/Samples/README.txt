...
=========================
  ...
  4. Building sample bitfiles using AMD ISE
  5. Building sample bitfiles using AMD Vivado
  6. Building sample bitfiles using Intel Quartus
...
To build the C/C++ samples, Microsoft Visual Studio 2019 projects (Windows)
...
reference the native compilers.
   ...
   libraries depending on architecture:
      32-bit builds: $(WXWIN)\lib\vc142_lib
      64-bit builds: $(WXWIN)\lib\vc142_x64_lib
   ...
   This puts the resulting libraries in the directories listed above.
      ...
      4. For 32-bit build (must use a 32-bit Visual Studio Command Line)
         nmake -f makefile.vc COMPILER_PREFIX=vc142 BUILD=release -sa
      5. For 64-bit build (must use a 64-bit Visual Studio Command Line)
         nmake -f makefile.vc COMPILER_PREFIX=vc142 BUILD=release TARGET_CPU=X64 -sa
...
project, but might differ in a specific detail or two.  In particular:
   ...
   + Simulation projects have the additional "okHostCalls.v" or "okHostCalls.vh" file which 
...
4. BUILDING SAMPLES BITFILES USING AMD ISE
=============================================
This will briefly guide you through the setup of a AMD
...
If you are new to ISE Project Navigator, you should review the AMD 
...
of AMD ISE was used to produce the NGC files.  Note that these files
...
5. BUILDING SAMPLES BITFILES USING AMD VIVADO
=============================================
This will briefly guide you through the setup of a AMD
...
If you are new to Vivado, you should review the AMD 
...
For the Counters (XEM8320-Verilog) sample, this is:
   + Counters.v     - Counters Verilog source.
Copy the XDC constraints file from the Samples directory. For the XEM8320,
this is:
   + xem8320.xdc    - Constraints file for the XEM8320 board.


Step 3: Copy Opal Kelly FrontPanel HDL files
--------------------------------------------
From the FrontPanel installation directory, copy your board's FrontPanel HDL
into your new Project directory. For the XEM8320 these will be located at:
FrontPanelHDL\XEM8320-AU25P\Vivado-2021

Note: These sources are encrypted with 2021 Vivado public keys, hence they are
located within the Vivado-2021 folder. For more information about which key
encrypted sources you should use for your project refer to the README within the
FrontPanelHDL folder.
...
6. BUILDING SAMPLES BITFILES USING Intel QUARTUS
=================================================
This will briefly guide you through the setup of an Intel Quartus
...
If you are new to Quartus, you should review the Intel documentation
...
follow these steps once for an installation of Quartus.
  ...
  B. Add the path to okIntelLicense.dat in the License File field.
