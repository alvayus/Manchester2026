...
The provided bitfile has been precompiled for Opal Kelly modules.
The bitfile for your product can be found in the "bitfiles" folder
of your FrontPanel SDK installation or through our downloads page
under the "FRONTPANEL SAMPLE BITFILES" .zip file for your product.

FlashLoader sources are currently provided for the XEM8350 and XEM8320.
...
Source code for this project is not presently available for all devices.
