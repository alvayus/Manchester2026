...
---------------------
   1. Copy simulation files from the FrontPanel installation directory
      ($FRONTPANEL)/Samples/First/Simulation-USB3-VHDL to a working
      directory ($WORKDIRECTORY)

   2. Copy VHDL simulation sources from $FRONTPANEL/Simulation/USB3/VHDL
...
Notes:
 ...
 first_isim.bat:
  ...
  environment variables if running from Windows 'Command Prompt'.
  Default path uses %Xilinx% environment variable, if set
